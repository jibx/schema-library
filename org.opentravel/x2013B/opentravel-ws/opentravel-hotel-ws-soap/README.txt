...
3. Install the example by entering the following commands in
   the ServiceMix console:
     ...
     obr:deploy 'Schema Library - org.opentravel.touractivity - 2013B - opentravel.org touractivity schema'
     install mvn:org.jibx.schema.org.opentravel.ws/org.jibx.schema.org.opentravel.x2013B.touractivity.ws/1.0.3-SNAPSHOT
...
In karaf, change the httpaddress property by tytouractivity:
  config:edit org.jibx.schema.org.opentravel.x2013B.hotel.ws.soap
