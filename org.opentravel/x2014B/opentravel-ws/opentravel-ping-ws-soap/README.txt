...
3. Install the example by entering the following commands in
   the ServiceMix console:
     ...
     obr:deploy 'Schema Library - org.opentravel.ping - 2014B - opentravel.org ping schema'
     install mvn:org.jibx.schema.org.opentravel.ws/org.jibx.schema.org.opentravel.x2014B.ping.ws/1.0.3-SNAPSHOT
...
URL:
  ...
  http://localhost:8092/soap/ping?wsdl
...
In karaf, change the httpaddress property by typing:
  ...
  config:propset httpAddress http://localhost:8082/soap/ping
  config:update
