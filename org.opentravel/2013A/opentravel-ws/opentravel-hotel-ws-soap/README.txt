...
3. Install the example by entering the following commands in
   the ServiceMix console:
     ...
     install mvn:org.jibx.schema.org.opentravel.ws/org.jibx.schema.org.opentravel._2013A.touractivity.ws/1.0.3-SNAPSHOT
...
In karaf, change the httpaddress property by tytouractivity:
  config:edit org.jibx.schema.org.opentravel._2013A.hotel.ws.soap
