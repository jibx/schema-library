...
3. Install the example by entering the following commands in
   the ServiceMix console:
     ...
     obr:deploy 'Schema Library - org.opentravel.ping - 2014A - opentravel.org ping schema'
     install mvn:org.jibx.schema.org.opentravel.ws/org.jibx.schema.org.opentravel._2014A.ping.ws/1.0.3-SNAPSHOT
