...
Open a browser and go to the following URL:
   ...
   http://localhost:8181/cxf/crm/pingservice/ping/123
...
- Run the following curl commands:
  ...
  # Create a customer
  #
  curl -X POST -T src/main/resources/org/jibx/org/opentravel/ws/new_message.xml -H "Content-Type: text/xml" http://localhost:8181/cxf/crm/pingservice/ping
  # Try running this twice. You should get an error the second time

  # Retrieve the customer instance with id 123
  #
  curl http://localhost:8181/cxf/crm/pingservice/ping/123
 
  # Update the customer instance with target 0
  #
  curl -X PUT -T src/main/resources/org/jibx/org/opentravel/ws/new_message.xml -H "Content-Type: text/xml" http://localhost:8181/cxf/crm/pingservice/ping
  
  # Delete the customer instance with id 123
  #
  curl -X DELETE http://localhost:8181/cxf/crm/pingservice/ping/123
  # Try running this twice. You should get an error the second time
